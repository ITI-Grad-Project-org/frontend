...
const secondaryBtnCls =
    `${primaryBtnCls} border border-border text-foreground hover:bg-muted`;

const destructiveBtnCls =
    `${primaryBtnCls} border border-destructive/20 bg-destructive/5 text-destructive hover:bg-destructive/10`;

const brandBtnCls =
    `${primaryBtnCls} bg-brand text-brand-foreground hover:opacity-90`;
...
export function PlanCard({
    ...
    return (
        <article className="rounded-3xl border border-border bg-background p-5 transition hover:border-brand/40">
            ...
            {/* PUBLISHED / SCHEDULED: Reschedule · Cancel · Archive */}
            {isScheduled && (
                <div className="mt-5 grid gap-2 sm:grid-cols-3">
                    <button
                        type="button"
            ...
            {/* PUBLISHED / ACTIVE: Cancel · Archive */}
            {isActive && (
            ...
            {/* CANCELLED: Archive (if not yet archived) */}
