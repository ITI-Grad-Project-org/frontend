...
interface MealFiltersProps {
  ...
  onFiltersChange: (next: Partial<MealsFilters>) => void;
  onResetFilters: () => void;
  onRefresh?: () => void;
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <input
            ...
            placeholder="Search meals by recipe name…"
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative min-w-[160px] flex-1">
          <select
            ...
            onChange={(e) =>
              onFiltersChange({ dietaryTag: e.target.value as MealsFilters["dietaryTag"] })
            }
            className={selectCls}
          >
