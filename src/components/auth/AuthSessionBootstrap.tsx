...
import { restoreSession } from "@/lib/api";
import { getCoachProfile } from "@/services/coaches";
import { refreshTokenStorageKey, setRefreshTokenFromExternalUpdate } from "@/lib/token-session";
import { useAuthStore } from "@/stores/auth-store";
...
export function AuthSessionBootstrap({ children }: PropsWithChildren) {
    ...
    useEffect(() => {
        ...
        const handleStorage = (event: StorageEvent) => {
            if (event.key === refreshTokenStorageKey) {
                setRefreshTokenFromExternalUpdate(event.newValue);
