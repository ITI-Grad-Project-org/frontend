...
import { LayoutDashboard, LogOut, Plus, Save, Trash2, Building2, Calendar, CheckCircle2, User, XCircle, ExternalLink, Star } from "lucide-react";
        ...
        <div className="min-h-screen px-6 py-8 bg-background text-foreground sm:py-12">
            <div className="w-full max-w-4xl mx-auto">
                ...
                <div className="grid gap-6 lg:grid-cols-3 animate-content">
                    <form onSubmit={handleSubmit(onSubmit)} className="lg:col-span-2 space-y-6 order-2 lg:order-1">
                        ...
                        <section className="rounded-2xl border border-border bg-card p-5 shadow-(--shadow-card) sm:p-7">
                            <div className="flex flex-wrap items-center justify-between gap-3">
                                ...
                                <button type="button" onClick={() => append({ name: "", issuer: "", year: "", credentialUrl: "" })}
