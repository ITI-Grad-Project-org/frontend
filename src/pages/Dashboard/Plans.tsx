function Plans() {
    return (
        <>
            <h1 className="mb-12 text-4xl font-black animate-in fade-in slide-in-from-left-3 duration-600">Plans</h1>

            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-left-3 duration-800">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="card-surface p-6 min-h-40 flex flex-col justify-between">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="card-ink md:col-span-2 p-6 min-h-55 flex flex-col justify-between">
                    ...
                    <div className="card-brand p-6 min-h-55 flex flex-col justify-between">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="card-surface p-6 min-h-35 flex flex-col justify-between">
