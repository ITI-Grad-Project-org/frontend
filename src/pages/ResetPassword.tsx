...
function ResetPassword() {
    ...
    const onSubmit = async (data: ResetPasswordFormData) => {
        ...
        try {
            ...
            const message = getApiErrorMessage(error, "We could not reset your password. The link may have expired.");
    ...
    return (
        <div className="animate-in fade-in zoom-in-95 duration-700 flex min-h-screen items-center justify-center bg-background px-6 py-12">
